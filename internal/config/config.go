...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		PostgresDSN:      envOr("TELESRV_POSTGRES_DSN", envOr("TELESRV_POSTGRES_URI", envOr("DATABASE_URL", "postgres://telesrv:telesrv@127.0.0.1:5432/telesrv?sslmode=disable"))),
		PostgresMaxConns: envIntOr("TELESRV_POSTGRES_MAX_CONNS", 50),
		PostgresMinConns: envIntOr("TELESRV_POSTGRES_MIN_CONNS", 16),
		RedisAddr:        envOr("TELESRV_REDIS_ADDR", envOr("TELESRV_REDIS_URI", "127.0.0.1:6399")),
